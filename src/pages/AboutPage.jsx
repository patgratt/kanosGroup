          ...
          <div className="prose-copy">
            <p>
              <strong>
                ...
                organizations so that we can create more meaningful connections in the world.
              </strong>{" "}
              We do this by helping organizations discover, craft, and communicate their authentic voice
              through high-level and intentional strategies.
            </p>
            <p>
            ...
            <p>
              <strong>
                We offer complete marketing support in our end-to-end campaign package, covering
          ...
          <div className="values-grid">
            <article className="value-card">
              ...
              <p>
                ...
                the biggest leverage they have is their brand. Creating and owning things that are unique
                to you not only gives you a position in the market, but it creates intangible assets that
                only you have.
              </p>
            </article>
            <article className="value-card">
              ...
              <p>
                ...
                in critical thinking, purpose, and intention, over simply pumping out content for the
                sake of it. We believe that good marketing amplifies a company’s purpose, builds trust
                and credibility, and forms meaningful connections with audiences. On the flip side, bad
            ...
            <article className="value-card">
              ...
              <p>
                ...
                make is thought-out, validated, and intentional. This contributes to fresh perspectives,
                new ideas, and an academic-style professional environment for bold and creative people.
                We believe valuable ideas can stem from anywhere. We want people that not only embrace
            ...
            <article className="value-card">
              ...
              <p>
                ...
                thinking allows us to deliver reliable results and for you to operate with confidence.
                We hold the quality of work above all else and aim to give you clarity with every
                decision we make.
              </p>
            </article>
          </div>
